...
private:
    ...
    double lastTimeChannel1 = 0.0;
    double lastTimeChannel2 = 0.0;
...
public:
    ...
    void plotDataChannel(QCPGraph *graph, int channelTime, double &currentTime, int receivedFrequency, int receivedDutyCycle, int &updateTimeFlag);
